...
class SettingsManager:
    ...
    def load_settings(self):
        ...
        if settings_data:
            settings = {
                "x1": int(settings_data.get("alert_region_1", {}).get("x", "default_value")),
                "y1": int(settings_data.get("alert_region_1", {}).get("y", "default_value")),
                "x2": int(settings_data.get("alert_region_2", {}).get("x", "default_value")),
                "y2": int(settings_data.get("alert_region_2", {}).get("y", "default_value")),
                "x1_faction": int(settings_data.get("faction_region_1", {}).get("x", "default_value")),
                "y1_faction": int(settings_data.get("faction_region_1", {}).get("y", "default_value")),
                "x2_faction": int(settings_data.get("faction_region_2", {}).get("x", "default_value")),
                "y2_faction": int(settings_data.get("faction_region_2", {}).get("y", "default_value")),
                "detection": settings_data.get("detectionscale", {}).get("value", None),
                "mode": settings_data.get("detection_mode", {}).get("value", "picture"),
                "cooldowntimer": settings_data.get("cooldown_timer", {}).get("value", 60),
                "change": False
            }
