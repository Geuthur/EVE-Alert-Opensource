...
class ConfigMenu:
    ...
    def open_description_window(self):
        ...
        if not self.active:
            ...
            self.main.buttons.config_button.configure(fg_color="#fa0202", hover_color="#bd291e")
            ...
            config_window_x = main_menu_x + main_menu_width + 10
            config_window_y = main_menu_y + main_menu_height + 40 if self.main.config_mode else main_menu_y
            if not self.main.descmenu.active:
                config_window_y = main_menu_y

            self.config_window.geometry(f"{config_window_width}x{config_window_height}+{config_window_x}+{config_window_y}")
            ...
            def close_config_window():
                self.main.buttons.config_button.configure(fg_color="#1f538d", hover_color="#14375e")
    ...
    def update_mode(self):
        ...
        if selected_mode == "color" and self.main.alarm.get_vision() == True:
